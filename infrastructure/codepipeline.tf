...
resource "aws_s3_bucket" "codepipeline_artifacts" {
  bucket = "samuel-codepipeline-artifacts-${random_string.bucket_suffix.result}"
}
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = aws_cloudfront_distribution.resume_distribution.arn
      }
    ]
  })
}
  ...
  stage {
    ...
    action {
      ...
      configuration = {
        ...
        Repo       = "cloud-resume-project"  # Replace with your repo name
        Branch     = "main"
